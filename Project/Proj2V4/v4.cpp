...
* Name: Ashton Cramer
* Date: 5/27/2025
* Purpose: Black Jack. Project 2, Version 4. Basic card picking program, now
...
void gmeLoop(char *, bool &, Card [], DlrCard [], ExtrPyr [], int, int, int, int, int, int, string, int); //the cycle of the turns
...
int main(){
    ...
    gmeLoop(ptrArr, won, cardArr, dlrArr, exPlArr, counter, dlrCntr, stayCtr, size, choose, chosen, player, plyrSze);
                                                    ...
                                                    string player, int plyrSze)
{
    ...
    while(won != true){
        ...
        if(prmpt == 1){
            ...
            cout << player << " pulled: " << plyrArr[0] << endl << endl;
        }
        else if(prmpt == 2){
